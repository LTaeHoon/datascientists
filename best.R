best <- function(state, outcome){
  ...
  if(outcome=="heart attack"){
    ...
    ordered <- arrange(selected,Hospital.30.Day.Death..Mortality..Rates.from.Heart.Attack)
    ...
    ordered <- arrange(selected,Hospital.30.Day.Death..Mortality..Rates.from.Heart.Failure)
    ...
    ordered <- arrange(selected,Hospital.30.Day.Death..Mortality..Rates.from.Pneumonia)
  }
